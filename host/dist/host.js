...
var moduleMap = {
	"./Counter": () => {
		var e = new Error("Cannot find module './src/components/Counter/index'"); e.code = 'MODULE_NOT_FOUND'; throw e;
	}
};
...
/******/ 					} else {
/******/ 						if(!/^webpack_sharing_consume_default_react(_react\-(_76(46|b1)|webpack_sharing_consume_default_react_react)|\-dom_react\-dom\-webpack_sharing_consume_default_react_react)$/.test(chunkId)) {
